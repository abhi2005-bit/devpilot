...
router = APIRouter(
    prefix="/projects/{project_id}/engineering-signals",
    tags=["Engineering Signals"],
)


@router.get(
    "",
    response_model=EngineeringSignals,
)
async def read_project_engineering_signals(
    project_id: str,
    ...
    return engineering_signal_service.get_project_signals(
        metrics=metrics,
    )
